...
const Skills = () => {
  ...
  const backendSkills = [
    ...
    { name: "Express", icon: <SiExpress className="text-gray-800 dark:text-gray-200 text-3xl" /> },
  ...
  const toolsSkills = [
    { name: "GitHub", icon: <FaGithub className="text-gray-900 dark:text-gray-200 text-3xl" /> },
    ...
    { name: "Vercel", icon: <SiVercel className="text-black dark:text-white text-3xl" /> },
  ];
    ...
    <section id="skills" className="py-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Frontend */}
          <div className="bg-white dark:bg-gray-800 p-6 font-raleway border-2 border-violet-500 shadow-lg shadow-slate-300 dark:shadow-black rounded-lg transition-all">
